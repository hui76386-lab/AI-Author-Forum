...
24. 子期刊编辑通过技术组“子期刊编辑基础访问”获得 Wagtail 登录和最小模型入口；该技术组不是业务角色，也不提供全站数据权限。
...
28. 主编辑和常务副编辑的“本刊投放”只包括本刊首页、本刊栏目/分类和本刊文章位；主站、全局栏目、搜索页、其他期刊和跨刊推荐位只允许超级管理员。
...
| 主编辑 | `chief_editor` | 被分配的子期刊 | 负责本刊全部内容和编辑团队、分配工作、初审、终审、确认本刊可发布内容 | 不能管理其他子期刊、超级管理员账号和平台级配置 |
| 常务副编辑 | `executive_editor` | 被分配的子期刊 | 协助主编辑、统筹日常维护、分派初审、执行初审、跟进退修和待办 | 不能终审、不能更换主编辑、不能管理平台账号 |
| 副编辑 | `associate_editor` | 被分配的子期刊 | 文章初审、日常内容维护，并按分配职责维护期刊资料 | 不能终审、不能查看其他子期刊、不能修改角色 |
...
交付：主编辑/常务副编辑本刊投放权限和超级管理员全局发布权限，跨刊目标拦截。  
验收：未终审或 revision 不一致的文章不能投放；本刊编辑不能操作主站、搜索页或其他期刊；只有超级管理员能激活和回滚；manifest 规则不变。
...
- [ ] 未终审文章不能创建正式投放；
- [ ] 主编辑和常务副编辑只能管理本刊投放；
- [ ] 主编辑和常务副编辑不能操作主站、全局栏目、搜索页、其他期刊或跨刊推荐位；
- [ ] 副编辑不能直接创建正式投放；
- [ ] 只有超级管理员可以构建、激活、重试和回滚；
