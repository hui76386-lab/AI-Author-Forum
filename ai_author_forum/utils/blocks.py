...
from ai_author_forum.journals.validators import validate_public_link
from ai_author_forum.utils.struct_values import CardStructValue, LinkStructValue
...
class ExternalLinkBlock(blocks.StructBlock):
    link = blocks.URLBlock(validators=[validate_public_link])
    title = blocks.CharBlock()
